...
export const permissionCatalog: Array<{
  ...
  },
  {
    ...
    items: [
      ...
      { key: "media.manage", labelBn: "মিডিয়া সেন্টার", labelEn: "Media Center" },
...
export const sidebarGroups: SidebarGroup[] = [
  ...
  {
    key: "media",
    labelBn: "মিডিয়া সেন্টার",
    labelEn: "Media Center",
    items: [
      { key: "media-dashboard", labelBn: "মিডিয়া ড্যাশবোর্ড", labelEn: "Dashboard", path: "/admin/media", permission: "media.manage", icon: PlayCircle },
      { key: "media-videos", labelBn: "ভিডিও", labelEn: "Videos", path: "/admin/media/videos", permission: "media.manage", icon: Video },
      { key: "media-playlists", labelBn: "প্লেলিস্ট", labelEn: "Playlists", path: "/admin/media/playlists", permission: "media.manage", icon: ListVideo },
      { key: "media-live", labelBn: "লাইভ স্ট্রিম", labelEn: "Live Stream", path: "/admin/media/live", permission: "media.manage", icon: Radio },
      { key: "media-gallery", labelBn: "গ্যালারি", labelEn: "Gallery", path: "/admin/media/gallery", permission: "media.manage", icon: Images },
      { key: "media-downloads", labelBn: "ডাউনলোড", labelEn: "Downloads", path: "/admin/media/downloads", permission: "media.manage", icon: Download },
    ],
  },
  {
    key: "users",
